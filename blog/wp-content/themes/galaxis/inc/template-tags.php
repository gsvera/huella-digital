	...
	function galaxis_entry_footer() {
		...
		if ( 'post' === get_post_type() && has_tag() ) {
			...
			<span class="tag-links">
				<span class="screen-reader-text"><?php esc_html_e( 'Etiquetas:', 'galaxis' ); ?></span>
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Editar <span class="screen-reader-text">%s</span>', 'galaxis' ),
					array(
						'span' => array(
							'class' => array(),
						),
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Dejar un comentario<span class="screen-reader-text"> en %s</span>', 'galaxis' ),
						array(
							'span' => array(
								'class' => array(),
							),
	...
	function galaxis_posted_by() {
		...
		<span class="byline">
			...
			printf(
				...
				esc_html_x( 'Escrito por %s', 'post author', 'galaxis' ),
