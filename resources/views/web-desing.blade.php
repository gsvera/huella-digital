...
<div class="content-page d-flex-responsive p-0" style="align-items: center">
    ...
    <div class="col-12 col-md-5 mb-5 p-0">
        <img class="img-responsive" src="/assets/img/servicio/servicio-paginas-web.svg" alt="Servicio de paginas web">
    </div>
</div>
...
<div class="content-page">
    ...
    <div class="row m-0">
        ...
        <div class="col-6 col-md-4 p-0 mb-card-service">
            <div class="card-service-include">
                <div>
                    <img style="width: 27px;" src="/assets/icon/services/icon-service-brief.svg" alt="Icono servicio briefing">
                </div>
        ...
        <div class="col-6 col-md-4 p-0 mb-card-service">
            <div class="card-service-include">
                <div>
                    <img style="width: 27px;" src="/assets/icon/services/icon-service-experiencia-usuario.svg" alt="Icono de experiencia de usuario">
                </div>
        ...
        <div class="col-6 col-md-4 p-0 mb-card-service">
            <div class="card-service-include">
                <div>
                    <img style="width: 27px;" src="/assets/icon/services/icon-service-html.svg" alt="Icono html">
                </div>
        ...
        <div class="col-6 col-md-4 p-0 mb-card-service">
            <div class="card-service-include">
                <div>
                    <img style="width: 27px;" src="/assets/icon/services/icon-service-desarrollo.svg" alt="Icono de wen">
                </div>
        ...
        <div class="col-6 col-md-4 p-0 mb-card-service">
            <div class="card-service-include">
                <div>
                    <img style="width: 27px;" src="/assets/icon/services/icon-service-entrega.svg" alt="Icono de entrega de proyecto">
                </div>
