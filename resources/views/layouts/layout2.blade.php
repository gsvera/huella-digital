...
<div class="pop-menu" id="pop-menu">
    <div id="menu-close" class="text-white btn-close display-max">X</div>
    <ul>
...
<!-- SECTION CONTACT -->
            ...
            <form id="contact" action="{{url('/gracias')}}" method="post" class="row">
                ...
                <div class="col-12">
                    <textarea name="message" class="box-input mt-3 box-input-area FivoSans-Medium" name="" id="" cols="30" rows="10" placeholder="¿En qué te podemos ayuar?" required>{{old('message')}}</textarea>
                </div>
                <div class="recap">
            ...
            <div class="container">
                <div class="row padding-footer-mob">
                    ...
                    <div class="col-lg-3 col-sm-3 col-md-3 br-white pt-2 border-mob">
                        <aside class="widget">
                            <h3 class="text-white FivoSans-Bold text-center-mobile">Servicios de <br class="display-min"> Marketing Digital</h3>
